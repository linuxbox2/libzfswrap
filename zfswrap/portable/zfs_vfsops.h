...
#if !defined(_SYS_FS_ZFS_VFSOPS_H)

#ifndef	PORTABLE_FS_ZFS_VFSOPS_H
#define	PORTABLE_FS_ZFS_VFSOPS_H
...
#endif	/* PORTABLE_FS_ZFS_VFSOPS_H */
#endif  /* !defined(_SYS_FS_ZFS_VFSOPS_H) */
