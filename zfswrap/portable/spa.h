...
#if !defined(_SYS_SPA_H)

#ifndef PORTABLE_SPA_H
#define	PORTABLE_SPA_H
...
extern void zfs_ereport_post(const char *a_class, spa_t *spa, vdev_t *vd, zio_t *zio, uint64_t stateoroffset, uint64_t length);
...
#endif	/* PORTABLE_SPA_H */
#endif  /* !defined(_SYS_SPA_H) */
