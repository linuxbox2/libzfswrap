...
#if !defined(_SYS_REFCOUNT_H)

#ifndef	PORTABLE_REFCOUNT_H
#define	PORTABLE_REFCOUNT_H
...
int64_t refcount_add(refcount_t *rc, const void *holder_tag);
...
#endif  /* PORTABLE_REFCOUNT_H */
#endif  /* !defined(_SYS_REFCOUNT_H) */
